...
class DifficultyTableViewController: UITableViewController {
    ...
    let heuristics = ["Most Probable Value", "All Weighted Values"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "heuristicIdentifier", for: indexPath)

        // Configure the cell...
        cell.textLabel?.text = heuristics[indexPath.row]
